...
function LoginForm() {
  ...
  // };
            //event - событие
  const login = (event) => {
         // event.preventDefault - чтобы страница необновлялась(стандартное поведение браузера) при нажатии 
  ...
  return (
         //onSubmit -чтобы непередавались  емаил и пасворд в url: ,  при обновлении страницы
